  ...
  var t = {
    ...
    initEvents: function () {
      t.on("resize", function () {
        ...
        t.trigger("ready");
      }), window.onload && t.on("load", window.onload), window.onload = function eventInterceptor(e) {
        if (window.shouldPreventEvent("load")) {
          return;
        } else {
          const fn = function () {
            t.trigger("load");
    ...
    initMethods: function () {
      document.addEventListener ? !function (e, n) {
        ...
        var e,
            ...
            i = document,
            a = "DOMContentLoaded",
            r = /^loaded|^c/.test(window.getDocumentReadyState(i));
...
!function (t, e) {
  "function" == typeof undefined && define.amd ? define([], e) : "object" == typeof undefined ? module.exports = e() : t.skel = e();
}(this, function () {
  return skel;
});
  }
